...
**URL:** https://docs.ultravox.ai/api-reference/corpora/corpora-sources-get
...
### cURL Example
```bash
curl--requestGET\--urlhttps://api.ultravox.ai/api/corpora/{corpus_id}/sources/{source_id}\--header'X-API-Key: <api-key>'
```
