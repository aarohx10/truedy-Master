...
### cURL Example
```bash
curl--requestGET\--urlhttps://api.ultravox.ai/api/calls/{call_id}/stages/{call_stage_id}\--header'X-API-Key: <api-key>'
```
...
\
--url
https://api.ultravox.ai/api/calls/{call_id}/stages/{call_stage_id}
\
--header
'X-API-Key: <api-key>'
200
