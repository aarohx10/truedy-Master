...
**URL:** https://docs.ultravox.ai/api-reference/calls/calls-stages-tools-list
...
### cURL Example
```bash
curl--requestGET\--urlhttps://api.ultravox.ai/api/calls/{call_id}/stages/{call_stage_id}/tools\--header'X-API-Key: <api-key>'
```
