...
**URL:** https://docs.ultravox.ai/api-reference/tools/tools-list
...
### cURL Example
```bash
curl--requestGET\--urlhttps://api.ultravox.ai/api/tools\--header'X-API-Key: <api-key>'
```
...
child attributes
​
results.definition.requirements.httpSecurityOptions.options.requirements.
{key}
object
...
child attributes
​
results.definition.requirements.httpSecurityOptions.options.requirements.{key}.
queryApiKey
object
...
child attributes
​
results.definition.requirements.httpSecurityOptions.options.requirements.{key}.queryApiKey.
name
string
...
child attributes
​
results.definition.requirements.httpSecurityOptions.options.requirements.{key}.headerApiKey.
name
string
...
child attributes
​
results.definition.requirements.httpSecurityOptions.options.requirements.{key}.httpAuth.
scheme
string
...
child attributes
​
results.definition.requirements.httpSecurityOptions.options.ultravoxCallTokenRequirement.
scopes
string[]
...
child attributes
​
results.definition.staticResponse.
responseText
string
