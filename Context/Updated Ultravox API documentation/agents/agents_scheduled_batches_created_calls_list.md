...
**URL:** https://docs.ultravox.ai/api-reference/agents/agents-scheduled-batches-created-calls-list
...
### cURL Example
```bash
curl--requestGET\--urlhttps://api.ultravox.ai/api/agents/{agent_id}/scheduled_batches/{batch_id}/created_calls\--header'X-API-Key: <api-key>'
```
...
\
--url
https://api.ultravox.ai/api/agents/{agent_id}/scheduled_batches/{batch_id}/created_calls
\
--header
'X-API-Key: <api-key>'
200
