...
**URL:** https://docs.ultravox.ai/api-reference/agents/agents-calls-list
...
### cURL Example
```bash
curl--requestGET\--urlhttps://api.ultravox.ai/api/agents/{agent_id}/calls\--header'X-API-Key: <api-key>'
```
