...
// Empty until backend search endpoint is implemented
...
export function GlobalSearch({ isOpen, onClose }: GlobalSearchProps) {
  ...
  return (
    <>
      ...
      <div 
        className="fixed inset-0 z-50 bg-white/50 dark:bg-black/50 backdrop-blur-[12px] animate-in fade-in duration-200 pointer-events-auto"
        onClick={onClose}
      />
      
      {/* Modal - above overlay to prevent blur */}
      <div className="fixed inset-0 z-[60] flex items-start justify-center pt-[5vh] sm:pt-[10vh] pointer-events-none px-2 sm:px-4">
