  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-yellow-500/50 text-yellow-900 dark:text-yellow-100 dark:border-yellow-500 bg-yellow-50 dark:bg-yellow-950/20",
        info:
          "border-blue-500/50 text-blue-900 dark:text-blue-100 dark:border-blue-500 bg-blue-50 dark:bg-blue-950/20",
      },
    },
    defaultVariants: {
      variant: "default",
