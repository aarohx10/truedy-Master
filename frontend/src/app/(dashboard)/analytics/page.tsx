...
// Analytics data - empty until backend endpoint is implemented
...
const hourlyDistributionData: Array<{ hour: string; calls: number }> = []
const topCampaigns: Array<{ name: string; calls: number; success: string }> = []
