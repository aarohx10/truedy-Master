...
export default function DashboardPage() {
  ...
  // Map selectedRange to API time_range format
  ...
  const apiTimeRange = timeRangeMap[selectedRange] || 'last_month'
  
  const { data: statsData, isLoading: statsLoading } = useDashboardStats(apiTimeRange)
  ...
  const stats = statsData ? [
    {
      ...
      value: (statsData.total_calls ?? 0).toString(),
    },
    {
      title: 'Average duration',
      value: formatDuration(statsData.average_call_duration_seconds ?? 0),
    },
    {
      title: 'Total cost',
      value: (statsData.total_call_cost_usd ?? 0).toFixed(2),
      unit: 'USD',
    },
    {
      title: 'Average cost',
      value: (statsData.average_call_cost_usd ?? 0).toFixed(4),
      unit: 'USD/call',
    },
    {
