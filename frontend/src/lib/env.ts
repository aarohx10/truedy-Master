...
const optionalEnvVars = {
  ...
  // Use new redirect URL names (afterSignInUrl/afterSignUpUrl are deprecated).
  // Remove NEXT_PUBLIC_CLERK_AFTER_SIGN_IN_URL and NEXT_PUBLIC_CLERK_AFTER_SIGN_UP_URL from .env to silence Clerk's deprecation warning.
  NEXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL || '/dashboard',
  NEXT_PUBLIC_CLERK_SIGN_IN_FORCE_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_IN_FORCE_REDIRECT_URL || '/dashboard',
  NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL || '/select-org',
  NEXT_PUBLIC_CLERK_SIGN_UP_FORCE_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_UP_FORCE_REDIRECT_URL || '/select-org',
...
export const env = {
  ...
  CLERK_SIGN_IN_FALLBACK_REDIRECT_URL: optionalEnvVars.NEXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL,
  CLERK_SIGN_IN_FORCE_REDIRECT_URL: optionalEnvVars.NEXT_PUBLIC_CLERK_SIGN_IN_FORCE_REDIRECT_URL,
  CLERK_SIGN_UP_FALLBACK_REDIRECT_URL: optionalEnvVars.NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL,
  CLERK_SIGN_UP_FORCE_REDIRECT_URL: optionalEnvVars.NEXT_PUBLIC_CLERK_SIGN_UP_FORCE_REDIRECT_URL,
